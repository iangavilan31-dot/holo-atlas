...
export function buildHoloStyle(): StyleSpecification {
  return {
    ...
    layers: [
      { id: 'bg', type: 'background', paint: { 'background-color': '#0A141D' } },
      {
        id: 'sat',
        type: 'raster',
        source: 'sat',
      ...
      },
      {
        ...
        source: 'omt',
        'source-layer': 'water',
        paint: { 'fill-color': '#0c1e2a', 'fill-opacity': 0.62 },
      },
      {
      ...
      },
      {
        ...
        paint: {
          'text-color': '#CFE9F5',
          'text-opacity': 0.6,
          'text-halo-color': 'rgba(10,20,29,0.9)',
          'text-halo-width': 1.1,
        },
      },
      {
